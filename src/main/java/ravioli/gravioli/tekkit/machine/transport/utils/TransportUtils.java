package ravioli.gravioli.tekkit.machine.transport.utils;
...
public class TransportUtils {
    public static boolean canInventoryBlockRecieve(InventoryHolder block, ItemStack item, BlockFace input) {
